...
export default function Capilos() {
  const { t } = useTranslation("cosider");
  ...
  return (
    <div className="flex flex-col justify-center">
      ...
      <div className="lg:block hidden -z-20 w-full absolute top-0 left-0">
        <Image
          src="/agency/clients/cosider/blur1.svg"
      ...
      <div className="lg:hidden -z-20 w-full absolute top-0 left-0">
        <Image
          src="/agency/clients/cosider/bg-mobile.svg"
          alt="Background Image"
          width={1080}
          height={2565}
          className="select-none w-full"
      ...
      {/* Hero */}
      <div className="flex flex-col justify-between items-center w-9/12 mx-auto lg:mt-32 mt-10">
        <h1 className="text-white font-bold lg:text-[150px] text-6xl tracking-tight">
          Cosider
        </h1>
      ...
      <div className="w-full mt-20">
        <Image
          src="/agency/clients/cosider/header.png"
          alt="header image client cosider"
          width={1441}
          height={371}
          className="w-full relative -z-30 h-auto object-cover"
        />
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:gap-8 gap-2 rounded-4xl bg-linear-to-b from-blue-200 to-stone-100 mx-auto lg:p-10 p-4 mb-20 text-[#252525] items-start lg:text-base text-sm">
        <div className="flex flex-col justify-center items-start lg:gap-4">
          <Image src="/agency/clients/inpha-medis/insight-icon.svg" alt="icon" width={28} height={28} />
          <h3 className="text-lg lg:text-2xl font-[400]">
            {t("insights.client_label")}
          </h3>
          <p>Cosider</p>
        </div>
      ...
      {/* About */}
      <div className="flex lg:flex-row flex-col lg:gap-32 gap-10 justify-center items-center lg:mx-40 lg:mt-20 w-10/12 mx-auto mb-10">
        <Image
          src="/agency/clients/cosider/cosider-logo.png"
          alt="logo"
          width={454}
          height={232}
        />
        <div className="flex flex-col lg:gap-20 gap-10 justify-center lg:items-start items-center lg:w-5/12 w-10/12 lg:text-left text-center lg:text-xl text-base">
      ...
      <div className="relative flex flex-col justify-center items-center lg:mb-48">
        <div className="-z-20 w-full absolute -top-20 left-0">
          <Image
            src="/agency/clients/cosider/blur2.svg"
            alt="Background Image"
            width={1080}
            height={2565}
            className="select-none w-full"
        ...
        <h2 className="text-white font-bold text-5xl lg:text-8xl tracking-tight text-center lg:mt-32 mt-4 w-6/12">
          {t("graphic.title")}
        </h2>
        <h3 className="text-xl mt-10 lg:text-3xl text-white">
          {t("graphic.subtitle")}
        </h3>
      </div>

      {/* Cards */}
      <div className="w-full relative -z-50 lg:mt-40 mt-20">
        <Image
          src="/agency/clients/cosider/cosider-cards.jpg"
          alt="Background Image"
          width={1440}
          height={800}
          className="select-none w-full"
