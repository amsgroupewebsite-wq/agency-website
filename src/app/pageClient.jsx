...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Aurora background — single instance, adapts to device */}
      <div className={`absolute inset-0 -z-20 w-full h-full pointer-events-none bg-[#F9E9C5]/50`}  aria-hidden="true">
        <SoftAurora
      ...
      <div className="hidden lg:block">
        ...
        <div className="relative p-0 m-0 h-[150svh] lg:h-[200svh] xl:h-[150svh]">
          <section
